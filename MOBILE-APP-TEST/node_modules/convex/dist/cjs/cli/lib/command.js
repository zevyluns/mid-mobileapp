...
import_extra_typings.Command.prototype.addDeploymentSelectionOptions = function(action, options) {
  ...
  return this.addOption(urlOption).addOption(new import_extra_typings.Option("--admin-key <adminKey>").hideHelp()).addOption(
    ...
    ).conflicts(["--prod", "--deployment-name", "--url", "--deployment"]).hideHelp()
  ).addOption(
    new import_extra_typings.Option(
      "--deployment-name <deploymentName>",
      action + " the specified deployment."
    ).conflicts(["--prod", "--preview-name", "--url", "--deployment"]).hideHelp()
  ).addOption(
    new import_extra_typings.Option(
...
import_extra_typings.Command.prototype.addDeployOptions = function() {
  ...
  ).addOption(new import_extra_typings.Option("--debug-bundle-path <path>").hideHelp()).addOption(new import_extra_typings.Option("--debug").hideHelp()).addOption(new import_extra_typings.Option("--write-push-request <writePushRequest>").hideHelp()).addOption(new import_extra_typings.Option("--live-component-sources").hideHelp()).addOption(
    new import_extra_typings.Option(
      "--push-all-modules",
