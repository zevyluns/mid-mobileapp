...
export declare function innerEsbuild({ entryPoints, platform, dir, extraConditions, generateSourceMaps, plugins, chunksFolder, logLevel, includeSourcesContent, splitting, }: {
    entryPoints: string[];
