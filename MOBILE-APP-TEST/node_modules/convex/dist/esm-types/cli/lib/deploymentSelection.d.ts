...
import { AccountRequiredDeploymentType, DeploymentSelectionOptions, DeploymentSelectionWithinProject, DeploymentType } from "./api.js";
/**
...
export declare function getDeploymentSelection(ctx: Context, cliArgs: DeploymentSelectionOptions): Promise<DeploymentSelection>;
/**
