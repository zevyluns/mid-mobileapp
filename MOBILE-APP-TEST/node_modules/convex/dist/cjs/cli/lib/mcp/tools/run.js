...
const RunTool = {
  ...
  handler: async (ctx, args) => {
    ...
    const metadata = await (0, import_requestContext.getMcpDeploymentSelection)(ctx, deployment);
    const credentials = await (0, import_api.loadSelectedDeploymentCredentials)(ctx, metadata);
