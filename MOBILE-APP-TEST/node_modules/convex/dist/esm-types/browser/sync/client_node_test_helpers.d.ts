...
import { PaginatedQueryToken, QueryToken } from "./udf_path_utils.js";
...
export declare class UpdateQueue {
     ...
     */
    awaitPromiseAtIndexWithTimeout(i: number): Promise<Record<QueryToken | PaginatedQueryToken, any>>;
    onTransition: (client: BaseConvexClient, paginatedClient?: PaginatedQueryClient) => (updatedQueryTokens: (QueryToken | PaginatedQueryToken)[]) => void;
}
