...
class WebSocketManager {
  ...
  assembleTransition(chunk) {
    ...
    if (this.transitionChunkBuffer.chunks.length === chunk.totalParts) {
      ...
      this.transitionChunkBuffer = null;
      const transition = (0, import_protocol.parseServerMessage)(JSON.parse(fullJson));
  ...
  connect() {
    ...
    ws.onmessage = (message) => {
      ...
      let serverMessage = (0, import_protocol.parseServerMessage)(JSON.parse(message.data));
