...
export declare function bundleImplementations({ ctx, rootComponentDirectory, componentDirectories, nodeExternalPackages, extraConditions, verbose, includeSourcesContent, }: {
    ctx: Context;
