...
var import_paginated_query_client = require("./sync/paginated_query_client.js");
var import_udf_path_utils = require("./sync/udf_path_utils.js");
...
class ConvexClient {
  ...
  constructor(address, options = {}) {
    ...
    if (!this.disabled) {
      ...
      this._paginatedClient = new import_paginated_query_client.PaginatedQueryClient(
        this._client,
  ...
  _transition({
    ...
    for (const queryInfo of this.listeners) {
      ...
      const isPaginatedQuery = (0, import_udf_path_utils.serializedQueryTokenIsPaginated)(queryToken);
