...
import type { CloudDeploymentType } from "../api.js";
...
export declare const BIG_BRAIN_URL: string;
...
export declare function selectRegionOrUseDefault(ctx: Context, selectedTeam: TeamResponse, deploymentType: CloudDeploymentType): Promise<string | null>;
export declare function selectRegion(ctx: Context, teamId: number, deploymentType: CloudDeploymentType): Promise<string | null>;
...
export declare function bigBrainAPI<T = any>({ ctx, method, path, data, }: {
    ctx: Context;
...
export declare function bigBrainAPIMaybeThrows({ ctx, method, path, data, }: {
    ctx: Context;
    method: "GET" | "POST" | "HEAD";
    path: string;
    data?: any;
