...
Command.prototype.addDeploymentSelectionOptions = function(action, options) {
  ...
  return this.addOption(urlOption).addOption(new Option("--admin-key <adminKey>").hideHelp()).addOption(
    new Option(
      "--prod",
...
Command.prototype.addDeployOptions = function() {
  ...
  ).addOption(new Option("--debug-bundle-path <path>").hideHelp()).addOption(new Option("--debug").hideHelp()).addOption(new Option("--write-push-request <writePushRequest>").hideHelp()).addOption(new Option("--live-component-sources").hideHelp()).addOption(
    new Option(
      "--push-all-modules",
