...
export function hash(bundle) {
  return createHash("sha256").update(bundle.source).update(bundle.sourceMap || "").digest("hex");
}
...
export function partitionModulesByChanges(functions, remoteHashesByPath) {
