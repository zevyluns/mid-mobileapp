  ...
  if (!warned) {
    ...
    console.warn(
      import_chalk.chalkStderr.gray(
        `  If you're running into errors with other tools watching the project directory, override the temporary directory location with the ${import_chalk.chalkStderr.bold(
          tmpDirOverrideVar
