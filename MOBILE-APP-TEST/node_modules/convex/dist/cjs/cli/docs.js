...
async function openDocs(ctx, toOpen, cookie) {
  ...
  if (toOpen) {
    ...
    (0, import_log.logMessage)(import_chalk.chalkStderr.green("Docs have launched! Check your browser."));
  } else {
    (0, import_log.logMessage)(import_chalk.chalkStderr.green(`Find Convex docs here: ${docsUrl}`));
  }
}
